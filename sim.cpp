...
int main(int argc, char *argv[])
{
  ...
  // ./sim sublattice l1 l2 final_T max_metro_sweeps max_det_sweeps phi
  const uint type = 0;
  ...
  const double G = sin(phi*pi);
  const double Gp = cos(phi*pi);
  ...
  return 0;
  // const double initial_T = 1;
  // // ./sim sublattice l1 l2 final_T max_metro_sweeps max_det_sweeps phi g a
  // const uint type = 0;
  // const uint sublattice = strtol(argv[1], NULL, 10);
  // const uint l1 = strtol(argv[2], NULL, 10);
  // const uint l2 = strtol(argv[3], NULL, 10);
